...
$emailTO[] = array( 'email' => 'seyonec@gmail.com', 'name' => 'Seyone Chithrananda' ); 

### Enable bellow parameters & update your BCC email if require.
$emailBCC[] = array( 'email' => 'seyome.chithrananda@student.tdsb.on.ca', 'name' => ' Seyone Chithrananda ' );
